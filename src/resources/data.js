...
export const data = [

    {
        ...
        name: 'Portfolio',
        logo: "profile.png",
        thumbnail: 'portfolio-ss-min.png',
        description: {
    ...
    },
    {
        ...
        name: 'MiniReddit',
        logo: "minireddit.png",
        thumbnail: 'minireddit-ss-min.png',
        description: {
            ...
            p5: `The App also incorporates responsive design encompassing most phones, tablets and PCs.`
        },
    ...
    },
    {
        ...
        name: 'Pic Some',
        logo: "picsome.png",
        thumbnail: 'picsome-ss-min.png',
        description: {
            p1: `Pic Some was made as an end of course project for the Scrimba React Course.`,
